...
RUN git clone -b containerized-support https://github.com/instill-ai/model-backend.git
...
ARG API_GATEWAY_VERSION MGMT_BACKEND_VERSION CONSOLE_VERSION PIPELINE_BACKEND_VERSION MODEL_BACKEND_VERSION
