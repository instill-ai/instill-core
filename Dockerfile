...
RUN git clone -b huitang/ins-3138 https://github.com/instill-ai/pipeline-backend.git
...
RUN git clone -b huitang/ins-3138 -c advice.detachedHead=false https://github.com/instill-ai/pipeline-backend.git
