...
integration-test:
	# @TEST_FOLDER_ABS_PATH=${PWD}/tests/integration-tests ./k6 run tests/integration-tests/model-backend-rest.js --no-usage-report
	@TEST_FOLDER_ABS_PATH=${PWD}/tests/integration-tests ./k6 run tests/integration-tests/pipeline-backend-rest.js --no-usage-report
